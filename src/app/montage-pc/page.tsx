...
const serviceSchema = {
  ...
  description:
    "Assemblage de PC sur-mesure (jeu, bureautique, familial) avec choix des composants, montage soigné et réglages. Le client achète les pièces, l'assemblage se fait depuis Saint-Laurent-Médoc, récupération sur rendez-vous.",
  url: PAGE_URL,
  areaServed: [
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        <div className="space-y-6 text-lg text-soft leading-relaxed">
          <p>
            ...
            l&rsquo;assemblage et des réglages depuis Saint-Laurent-Médoc, pour
            la Gironde (récupération sur rendez-vous).
          </p>
